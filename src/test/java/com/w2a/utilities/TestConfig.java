...
public class TestConfig{
	...
	public static String from = "seleniumtest9029@gmail.com";
	public static String password = "Selenium@2019";
	public static String[] to ={"rehanmomin9029@gmail.com","tester.rehan@gmail.com"};
